        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="bg-[#0a1525] p-6 rounded-lg text-left">
            ...
            <p className="text-gray-300 text-sm">
              From ideation to execution, we craft integrated campaigns that
              build awareness.
            </p>
          </div>
          ...
          <div className="bg-[#0a1525] p-6 rounded-lg text-left">
            ...
            <p className="text-gray-300 text-sm">
              We spark conversations and build community through social-first
              ideas.
            </p>
          </div>
          ...
          <div className="bg-[#0a1525] p-6 rounded-lg text-left">
            ...
            <p className="text-gray-300 text-sm">
              We design and develop intuitive, high-performing websites and
              digital products.
            </p>
          </div>
          ...
          <div className="bg-[#0a1525] p-6 rounded-lg text-left">
            ...
            <p className="text-gray-300 text-sm">
              We analyze every step of your digital journey, measurable results
